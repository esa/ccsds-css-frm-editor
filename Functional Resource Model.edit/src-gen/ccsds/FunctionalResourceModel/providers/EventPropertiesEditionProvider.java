...
import ccsds.FunctionalResourceModel.components.EventPropertiesEditionComponent;
...
public class EventPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Event) 
					&& (FunctionalResourceModelPackage.Literals.EVENT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && FunctionalResourceModelPackage.Literals.EVENT == eObj.eClass();
		}
