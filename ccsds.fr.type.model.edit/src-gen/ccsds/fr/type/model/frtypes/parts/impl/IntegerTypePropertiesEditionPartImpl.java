 ...
 * 
 */
public class IntegerTypePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IntegerTypePropertiesEditionPart {
	 ...
	 * 
	 */
	public IntegerTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(integerTypeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == FrtypesViewsRepository.IntegerType.Properties.namedValues) {
					return createNamedValuesAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(FrtypesMessages.IntegerTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createRangeConstraintAdvancedTableComposition(Composite parent) {
		this.rangeConstraint = new ReferencesTable(getDescription(FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, FrtypesMessages.IntegerTypePropertiesEditionPart_RangeConstraintLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				rangeConstraint.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				rangeConstraint.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				rangeConstraint.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				rangeConstraint.refresh();
			}
		...
		this.rangeConstraint.setHelpText(propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, FrtypesViewsRepository.SWT_KIND));
		...
		this.rangeConstraint.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.rangeConstraint, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createNamedValuesAdvancedTableComposition(Composite parent) {
		this.namedValues = new ReferencesTable(getDescription(FrtypesViewsRepository.IntegerType.Properties.namedValues, FrtypesMessages.IntegerTypePropertiesEditionPart_NamedValuesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.namedValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				namedValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.namedValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				namedValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.namedValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				namedValues.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.namedValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				namedValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.namedValues.setHelpText(propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.IntegerType.Properties.namedValues, FrtypesViewsRepository.SWT_KIND));
		this.namedValues.createControls(parent);
		this.namedValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerTypePropertiesEditionPartImpl.this, FrtypesViewsRepository.IntegerType.Properties.namedValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createNamedValuesAdvancedTableComposition
