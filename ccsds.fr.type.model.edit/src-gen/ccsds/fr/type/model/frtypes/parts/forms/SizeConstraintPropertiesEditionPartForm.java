 ...
 * 
 */
public class SizeConstraintPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SizeConstraintPropertiesEditionPart {
	 ...
	 */
	public SizeConstraintPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SizeConstraintPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FrtypesMessages.SizeConstraintPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createMinText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SizeConstraintPropertiesEditionPartForm.this,
							FrtypesViewsRepository.SizeConstraint.Properties.min,
		...
		min.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SizeConstraintPropertiesEditionPartForm.this, FrtypesViewsRepository.SizeConstraint.Properties.min, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, min.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.SizeConstraint.Properties.min, FrtypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMaxText(FormToolkit widgetFactory, Composite parent) {
		...
		max.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SizeConstraintPropertiesEditionPartForm.this,
							FrtypesViewsRepository.SizeConstraint.Properties.max,
		...
		max.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SizeConstraintPropertiesEditionPartForm.this, FrtypesViewsRepository.SizeConstraint.Properties.max, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, max.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.SizeConstraint.Properties.max, FrtypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
