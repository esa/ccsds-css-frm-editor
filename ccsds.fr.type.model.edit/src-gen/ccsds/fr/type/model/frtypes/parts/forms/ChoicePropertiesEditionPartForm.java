	...
	protected Composite createElementsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.elements = new ReferencesTable(getDescription(FrtypesViewsRepository.Choice.Properties.elements, FrtypesMessages.ChoicePropertiesEditionPart_ElementsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChoicePropertiesEditionPartForm.this, FrtypesViewsRepository.Choice.Properties.elements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				elements.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChoicePropertiesEditionPartForm.this, FrtypesViewsRepository.Choice.Properties.elements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				elements.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChoicePropertiesEditionPartForm.this, FrtypesViewsRepository.Choice.Properties.elements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				elements.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChoicePropertiesEditionPartForm.this, FrtypesViewsRepository.Choice.Properties.elements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				elements.refresh();
			}
		...
		this.elements.setHelpText(propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.Choice.Properties.elements, FrtypesViewsRepository.FORM_KIND));
		...
		this.elements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChoicePropertiesEditionPartForm.this, FrtypesViewsRepository.Choice.Properties.elements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
