 ...
 * 
 */
public class CharacterStringPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CharacterStringPropertiesEditionPart {
	 ...
	 */
	public CharacterStringPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public CharacterStringPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FrtypesMessages.CharacterStringPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createSizeConstraintTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.sizeConstraint = new ReferencesTable(getDescription(FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, FrtypesMessages.CharacterStringPropertiesEditionPart_SizeConstraintLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				sizeConstraint.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				sizeConstraint.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				sizeConstraint.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				sizeConstraint.refresh();
			}
		...
		this.sizeConstraint.setHelpText(propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, FrtypesViewsRepository.FORM_KIND));
		...
		this.sizeConstraint.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.sizeConstraint, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		type.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CharacterStringPropertiesEditionPartForm.this, FrtypesViewsRepository.CharacterString.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getType()));
			}

		});
		type.setID(FrtypesViewsRepository.CharacterString.Properties.type);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FrtypesViewsRepository.CharacterString.Properties.type, FrtypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
