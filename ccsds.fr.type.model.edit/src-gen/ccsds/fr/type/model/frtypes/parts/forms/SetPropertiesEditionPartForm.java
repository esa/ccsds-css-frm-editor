...
public class SetPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SetPropertiesEditionPart {
	 ...
	 */
	public SetPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SetPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FrtypesMessages.SetPropertiesEditionPart_PropertiesGroupLabel);
