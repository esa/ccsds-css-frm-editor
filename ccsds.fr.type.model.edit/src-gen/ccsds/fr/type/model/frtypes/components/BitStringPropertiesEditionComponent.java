 ...
 * 
 */
public class BitStringPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public BitStringPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject bitString, String editing_mode) {
		super(editingContext, bitString, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = FrtypesViewsRepository.class;
		partKey = FrtypesViewsRepository.BitString.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final BitString bitString = (BitString)elt;
			final BitStringPropertiesEditionPart basePart = (BitStringPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(FrtypesViewsRepository.BitString.Properties.sizeConstraint)) {
				sizeConstraintSettings = new ReferencesTableSettings(bitString, FrtypesPackage.eINSTANCE.getSizeConstrainedType_SizeConstraint());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FrtypesViewsRepository.BitString.Properties.sizeConstraint) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		BitString bitString = (BitString)semanticObject;
		if (FrtypesViewsRepository.BitString.Properties.sizeConstraint == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			BitStringPropertiesEditionPart basePart = (BitStringPropertiesEditionPart)editingPart;
			if (FrtypesPackage.eINSTANCE.getSizeConstrainedType_SizeConstraint().equals(msg.getFeature()) && isAccessible(FrtypesViewsRepository.BitString.Properties.sizeConstraint))
