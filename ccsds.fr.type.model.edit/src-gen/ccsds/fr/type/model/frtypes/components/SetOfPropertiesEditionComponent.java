 ...
 * 
 */
public class SetOfPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SetOfPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject setOf, String editing_mode) {
		super(editingContext, setOf, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = FrtypesViewsRepository.class;
		partKey = FrtypesViewsRepository.SetOf.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final SetOf setOf = (SetOf)elt;
			final SetOfPropertiesEditionPart basePart = (SetOfPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(FrtypesViewsRepository.SetOf.Properties.sizeConstraint)) {
				sizeConstraintSettings = new ReferencesTableSettings(setOf, FrtypesPackage.eINSTANCE.getSizeConstrainedType_SizeConstraint());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FrtypesViewsRepository.SetOf.Properties.sizeConstraint) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		SetOf setOf = (SetOf)semanticObject;
		if (FrtypesViewsRepository.SetOf.Properties.sizeConstraint == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			SetOfPropertiesEditionPart basePart = (SetOfPropertiesEditionPart)editingPart;
			if (FrtypesPackage.eINSTANCE.getSizeConstrainedType_SizeConstraint().equals(msg.getFeature()) && isAccessible(FrtypesViewsRepository.SetOf.Properties.sizeConstraint))
