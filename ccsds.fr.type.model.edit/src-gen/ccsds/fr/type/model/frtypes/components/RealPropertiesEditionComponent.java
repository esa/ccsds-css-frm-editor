 ...
 * 
 */
public class RealPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public RealPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject real, String editing_mode) {
		super(editingContext, real, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = FrtypesViewsRepository.class;
		partKey = FrtypesViewsRepository.Real.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Real real = (Real)elt;
			final RealPropertiesEditionPart basePart = (RealPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(FrtypesViewsRepository.Real.Properties.rangeConstraint)) {
				rangeConstraintSettings = new ReferencesTableSettings(real, FrtypesPackage.eINSTANCE.getSimpleRangeType_RangeConstraint());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FrtypesViewsRepository.Real.Properties.rangeConstraint) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		Real real = (Real)semanticObject;
		if (FrtypesViewsRepository.Real.Properties.rangeConstraint == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			RealPropertiesEditionPart basePart = (RealPropertiesEditionPart)editingPart;
			if (FrtypesPackage.eINSTANCE.getSimpleRangeType_RangeConstraint().equals(msg.getFeature()) && isAccessible(FrtypesViewsRepository.Real.Properties.rangeConstraint))
