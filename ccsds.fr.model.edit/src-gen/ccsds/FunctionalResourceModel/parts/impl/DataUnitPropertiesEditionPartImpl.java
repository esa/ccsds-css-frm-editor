 ...
 * 
 */
public class DataUnitPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DataUnitPropertiesEditionPart {
	 ...
	 * 
	 */
	public DataUnitPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(dataUnitStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit) {
					return createSubDataUnitAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(FunctionalResourceModelMessages.DataUnitPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createSemanticDefinitionTextarea(Composite parent) {
		...
		semanticDefinition.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.semanticDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, semanticDefinition.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.semanticDefinition, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createClassifierText(Composite parent) {
		...
		classifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.classifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, classifier.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.classifier, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStringIdentifierText(Composite parent) {
		...
		stringIdentifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.stringIdentifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, stringIdentifier.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.stringIdentifier, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.version, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCreationDateText(Composite parent) {
		...
		creationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.creationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, creationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.creationDate, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorizingEntityText(Composite parent) {
		...
		authorizingEntity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.authorizingEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, authorizingEntity.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.authorizingEntity, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOidBitText(Composite parent) {
		...
		oidBit.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.oidBit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, oidBit.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.oidBit, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDeprecatedCheckbox(Composite parent) {
		...
		deprecated.setText(getDescription(FunctionalResourceModelViewsRepository.DataUnit.Properties.deprecated, FunctionalResourceModelMessages.DataUnitPropertiesEditionPart_DeprecatedLabel));
		deprecated.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.deprecated, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(deprecated.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.deprecated, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAnnotationAdvancedTableComposition(Composite parent) {
		this.annotation = new ReferencesTable(getDescription(FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, FunctionalResourceModelMessages.DataUnitPropertiesEditionPart_AnnotationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				annotation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				annotation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				annotation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				annotation.refresh();
			}
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, FunctionalResourceModelViewsRepository.SWT_KIND));
		this.annotation.createControls(parent);
		this.annotation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTypeDefinitionTextarea(Composite parent) {
		...
		typeDefinition.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.typeDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, typeDefinition.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.typeDefinition, FunctionalResourceModelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createSubDataUnitAdvancedTableComposition(Composite parent) {
		this.subDataUnit = new ReferencesTable(getDescription(FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, FunctionalResourceModelMessages.DataUnitPropertiesEditionPart_SubDataUnitLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				subDataUnit.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				subDataUnit.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				subDataUnit.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				subDataUnit.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.subDataUnit.setHelpText(propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, FunctionalResourceModelViewsRepository.SWT_KIND));
		this.subDataUnit.createControls(parent);
		this.subDataUnit.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataUnitPropertiesEditionPartImpl.this, FunctionalResourceModelViewsRepository.DataUnit.Properties.subDataUnit, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createSubDataUnitAdvancedTableComposition
