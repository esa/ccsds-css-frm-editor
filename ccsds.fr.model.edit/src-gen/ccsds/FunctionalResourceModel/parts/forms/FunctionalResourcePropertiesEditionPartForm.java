...
public class FunctionalResourcePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FunctionalResourcePropertiesEditionPart {
		...
		composer = new PartComposer(functionalResourceStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface) {
					return createProvidedAncillaryInterfaceTableComposition(widgetFactory, parent);
				}
				if (key == FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit) {
					return createDataUnitTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	 ...
	 * 
	 */
	protected Composite createServiceAccesspointTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.serviceAccesspoint = new ReferencesTable(getDescription(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, FunctionalResourceModelMessages.FunctionalResourcePropertiesEditionPart_ServiceAccesspointLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				serviceAccesspoint.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				serviceAccesspoint.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				serviceAccesspoint.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				serviceAccesspoint.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		for (ViewerFilter filter : this.serviceAccesspointFilters) {
			this.serviceAccesspoint.addFilter(filter);
		}
		this.serviceAccesspoint.setHelpText(propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, FunctionalResourceModelViewsRepository.FORM_KIND));
		this.serviceAccesspoint.createControls(parent, widgetFactory);
		this.serviceAccesspoint.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
			
		});
		GridData serviceAccesspointData = new GridData(GridData.FILL_HORIZONTAL);
		serviceAccesspointData.horizontalSpan = 3;
		this.serviceAccesspoint.setLayoutData(serviceAccesspointData);
		this.serviceAccesspoint.setLowerBound(0);
		this.serviceAccesspoint.setUpperBound(-1);
		serviceAccesspoint.setID(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint);
		serviceAccesspoint.setEEFType("eef::AdvancedTableComposition"); //$NON-NLS-1$
		// Start of user code for createServiceAccesspointTableComposition
	 ...
	 * 
	 */
	protected Composite createProvidedAncillaryInterfaceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.providedAncillaryInterface = new ReferencesTable(getDescription(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, FunctionalResourceModelMessages.FunctionalResourcePropertiesEditionPart_ProvidedAncillaryInterfaceLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				providedAncillaryInterface.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				providedAncillaryInterface.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				providedAncillaryInterface.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				providedAncillaryInterface.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		for (ViewerFilter filter : this.providedAncillaryInterfaceFilters) {
			this.providedAncillaryInterface.addFilter(filter);
		}
		this.providedAncillaryInterface.setHelpText(propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, FunctionalResourceModelViewsRepository.FORM_KIND));
		this.providedAncillaryInterface.createControls(parent, widgetFactory);
		this.providedAncillaryInterface.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
			
		});
		GridData providedAncillaryInterfaceData = new GridData(GridData.FILL_HORIZONTAL);
		providedAncillaryInterfaceData.horizontalSpan = 3;
		this.providedAncillaryInterface.setLayoutData(providedAncillaryInterfaceData);
		this.providedAncillaryInterface.setLowerBound(0);
		this.providedAncillaryInterface.setUpperBound(-1);
		providedAncillaryInterface.setID(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface);
		providedAncillaryInterface.setEEFType("eef::AdvancedTableComposition"); //$NON-NLS-1$
		// Start of user code for createProvidedAncillaryInterfaceTableComposition
	 ...
	 * 
	 */
	protected Composite createDataUnitTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.dataUnit = new ReferencesTable(getDescription(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, FunctionalResourceModelMessages.FunctionalResourcePropertiesEditionPart_DataUnitLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataUnit.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataUnit.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataUnit.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataUnit.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.dataUnit.setHelpText(propertiesEditionComponent.getHelpContent(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, FunctionalResourceModelViewsRepository.FORM_KIND));
		this.dataUnit.createControls(parent, widgetFactory);
		this.dataUnit.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FunctionalResourcePropertiesEditionPartForm.this, FunctionalResourceModelViewsRepository.FunctionalResource.Properties.dataUnit, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createDataUnitTableComposition
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#initServiceAccesspoint(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initServiceAccesspoint(ReferencesTableSettings settings) {
		if (current.eResource() != null && current.eResource().getResourceSet() != null)
			this.resourceSet = current.eResource().getResourceSet();
		ReferencesTableContentProvider contentProvider = new ReferencesTableContentProvider();
		serviceAccesspoint.setContentProvider(contentProvider);
		serviceAccesspoint.setInput(settings);
		boolean eefElementEditorReadOnlyState = isReadOnly(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.serviceAccesspoint);
		if (eefElementEditorReadOnlyState && serviceAccesspoint.isEnabled()) {
			serviceAccesspoint.setEnabled(false);
			serviceAccesspoint.setToolTipText(FunctionalResourceModelMessages.FunctionalResource_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !serviceAccesspoint.isEnabled()) {
			serviceAccesspoint.setEnabled(true);
		}	
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#updateServiceAccesspoint()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#addFilterServiceAccesspoint(ViewerFilter filter)
	 * 
	 */
	public void addFilterToServiceAccesspoint(ViewerFilter filter) {
		serviceAccesspointFilters.add(filter);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#addBusinessFilterServiceAccesspoint(ViewerFilter filter)
	 * 
	 */
	public void addBusinessFilterToServiceAccesspoint(ViewerFilter filter) {
		serviceAccesspointBusinessFilters.add(filter);
	}

	/**
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#isContainedInServiceAccesspointTable(EObject element)
	 * 
	 */
	public boolean isContainedInServiceAccesspointTable(EObject element) {
		return ((ReferencesTableSettings)serviceAccesspoint.getInput()).contains(element);
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#initProvidedAncillaryInterface(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initProvidedAncillaryInterface(ReferencesTableSettings settings) {
		if (current.eResource() != null && current.eResource().getResourceSet() != null)
			this.resourceSet = current.eResource().getResourceSet();
		ReferencesTableContentProvider contentProvider = new ReferencesTableContentProvider();
		providedAncillaryInterface.setContentProvider(contentProvider);
		providedAncillaryInterface.setInput(settings);
		boolean eefElementEditorReadOnlyState = isReadOnly(FunctionalResourceModelViewsRepository.FunctionalResource.Properties.providedAncillaryInterface);
		if (eefElementEditorReadOnlyState && providedAncillaryInterface.isEnabled()) {
			providedAncillaryInterface.setEnabled(false);
			providedAncillaryInterface.setToolTipText(FunctionalResourceModelMessages.FunctionalResource_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !providedAncillaryInterface.isEnabled()) {
			providedAncillaryInterface.setEnabled(true);
		}	
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#updateProvidedAncillaryInterface()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#addFilterProvidedAncillaryInterface(ViewerFilter filter)
	 * 
	 */
	public void addFilterToProvidedAncillaryInterface(ViewerFilter filter) {
		providedAncillaryInterfaceFilters.add(filter);
		if (this.providedAncillaryInterface != null) {
			this.providedAncillaryInterface.addFilter(filter);
		}
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#addBusinessFilterProvidedAncillaryInterface(ViewerFilter filter)
	 * 
	 */
	public void addBusinessFilterToProvidedAncillaryInterface(ViewerFilter filter) {
		providedAncillaryInterfaceBusinessFilters.add(filter);
	}

	/**
	 * {@inheritDoc}
	 * 
	 * @see ccsds.FunctionalResourceModel.parts.FunctionalResourcePropertiesEditionPart#isContainedInProvidedAncillaryInterfaceTable(EObject element)
	 * 
	 */
