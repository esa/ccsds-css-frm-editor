 ...
 * 
 */
public class OidPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public OidPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject oid, String editing_mode) {
		super(editingContext, oid, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = FunctionalResourceModelViewsRepository.class;
		partKey = FunctionalResourceModelViewsRepository.Oid.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FunctionalResourceModelViewsRepository.Oid.Properties.oidBit) {
			return FunctionalResourceModelPackage.eINSTANCE.getOid_OidBit();
		}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			FunctionalResourceModelPackage.eINSTANCE.getOid_OidBit()		);
			...
			try {
				if (FunctionalResourceModelViewsRepository.Oid.Properties.oidBit == event.getAffectedEditor()) {
					...
					for (Iterator iterator = ((List)event.getNewValue()).iterator(); iterator.hasNext();) {
						chain.add(Diagnostician.INSTANCE.validate(FunctionalResourceModelPackage.eINSTANCE.getOid_OidBit().getEAttributeType(), iterator.next()));
					}
					ret = chain;
				}
