...
/**
 * This is the item provider adapter for a {@link ccsds.FunctionalResourceModel.DataUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataUnitItemProvider extends FrModelElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionalResourceModelPackage.Literals.DATA_UNIT__TYPE_DEFINITION);
			childrenFeatures.add(FunctionalResourceModelPackage.Literals.DATA_UNIT__SUB_DATA_UNIT);
		}
	...
	public String getText(Object object) {
		String label = crop(((DataUnit)object).getClassifier());
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionalResourceModelPackage.Literals.DATA_UNIT__TYPE_DEFINITION,
				 FrtypesFactory.eINSTANCE.createTypeDefinition()));

		newChildDescriptors.add
			(createChildParameter
				(FunctionalResourceModelPackage.Literals.DATA_UNIT__SUB_DATA_UNIT,
