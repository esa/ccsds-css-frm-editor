...
/**
 * This is the item provider adapter for a {@link ccsds.FunctionalResourceModel.FunctionalResourceSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionalResourceSetItemProvider 
	 ...
	 * @generated
	 */
	public FunctionalResourceSetItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionalResourceSet_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionalResourceSet_name_feature", "_UI_FunctionalResourceSet_type"),
				 FunctionalResourceModelPackage.Literals.FUNCTIONAL_RESOURCE_SET__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionalResourceModelPackage.Literals.FUNCTIONAL_RESOURCE_SET__FUNCTIONAL_RESOURCE);
		}
	...
	/**
	 * This returns FunctionalResourceSet.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctionalResourceSet"));
	}
	...
	public String getText(Object object) {
		String label = ((FunctionalResourceSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FunctionalResourceSet_type") :
			getString("_UI_FunctionalResourceSet_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionalResourceModelPackage.Literals.FUNCTIONAL_RESOURCE_SET__FUNCTIONAL_RESOURCE,
