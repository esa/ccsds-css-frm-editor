...
public abstract class SimpleTypeImpl extends TypeImpl implements SimpleType {
	...
	public void writeXsd(int indentLevel, StringBuffer output, ObjectIdentifier oid) {
		...
		XmlHelper.writeElement(typeOutput, indentLevel, XmlHelper.RESTRICTION, new XmlAttribute(XmlHelper.BASE, baseType));
		...
		if(oid != null) {		
			...
			if(hasConstraints == true) {
				...
				XmlHelper.writeAttributeSpec(output, indentLevel+1, XmlHelper.VALUE, XmlHelper.INTEGER, XmlHelper.REQUIRED);
			}
