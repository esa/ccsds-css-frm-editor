...
,   halted   (3)&#xD;
    ...
    <parameter oidBit="2" authorizingEntity="CSTS WG" creationDate="2014-05-30T00:00:00.000+0200" name="carrier-signal" engineeringUnit="none">
      ...
      <semantic_definition>This enumerated parameter reports the current state of the carrier radiation and can take on three values:&#xD;
...
- 'down': the carrier is presently down, i.e. no signal is being radiated.</semantic_definition>
